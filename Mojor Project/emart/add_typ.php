...
<hr>
<center>
<form action="itm_typ.php" method="post">
<input type="text" name="itype" placeholder="Item type">
...
while($row=mysqli_fetch_assoc($res))
{
	...
	echo "<td><a href='edit_typ.php?iid=".$row['iid']."'><i class='far fa-edit' style='color:blue;'></i></a></td>";
	echo "<td><a href='del_typ.php?iid=".$row['iid']."'><i class='fa fa-trash' aria-hidden='true' style='color:red;'></i>
	</a></td>";
	echo "</tr>";
	$i++;
}
