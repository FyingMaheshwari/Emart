...
$sql = "select distinct cname,cid,dis from cat order by cname asc;";
...
<hr>
<center>
<form action="itm_cat.php" method="post">
<input type="text" name="icat" placeholder="Item Category">
<input type="text" name="idis" placeholder="Category Discount">
...
while($row=mysqli_fetch_assoc($res))
{
	...
	echo "<td>".$row['dis']."</td>";
	echo "<td><a href='edit_cat.php?cid=".$row['cid']."'><i class='far fa-edit' style='color:blue;'></i></a></td>";
	echo "<td><a href='del_cat.php?cid=".$row['cid']."'><i class='fa fa-trash' aria-hidden='true' style='color:red;'></i></a></td>";
	echo "</tr>";
	$i++;
}
?>
