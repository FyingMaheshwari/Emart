...
<html>
   ...
   <body>
      ...
      <div class="header-bar">
            ...
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
               <div class="shop_inner_inf">
                  <div class="privacy about">
                     <h3>Delivered<span> Orders</span></h3>
                     <div class="checkout-right">
                        <h4>Delivered Order contains <span>these Products:</span></h4>
         ...
         $sql = "select uemail,ono,product,img,qty,tprice,ostatus,oid from orders where ostatus='Delivered' order by oid desc;";
         ...
         {?>
            ...
            <td class="invert"><button type="button" class="btn btn-success"><?php echo $row['ostatus']; ?></button></td>
         </tr>
         <?php 
         $i++;
         }
