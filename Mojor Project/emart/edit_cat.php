...
<div class="container">
<?php echo "<form action='upd_cat.php?cid=$cid'  method='post'>"?>
<center><input type="text" name="cname" value="<?php echo $cname; ?>">&nbsp;&nbsp;&nbsp;
	<input type="text" name="idis" value="<?php echo $dis; ?>">&nbsp;&nbsp;&nbsp;
	<input type="submit" value="Edit" style="background-color: yellow;"></center>
</form>
</div><br /><br />
