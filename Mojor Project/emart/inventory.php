...
<?php
include('connect.php');
$sql1 = "select * from inventory order by pname asc;";
...
<h1 style="background-color: green; color: white; text-align: center;">Add Inventory</h1>
<hr>
<center>
<form action="add_inven.php" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="Input1">Item Name</label>
    <input type="text" id="Input1" name="iname" placeholder="Enter item name">
  </div>
  <div class="form-group">
...
<hr>
<h1 style="background-color: red; color: white; text-align: center;">Inventory Detail</h1>
<div class="container ">
...
while($row=mysqli_fetch_assoc($res))
{
	...
	echo "<td><a href='edit_inv.php?pid=".$row['pid']."'><i class='far fa-edit' style='color:blue;'></i></a></td>";
	echo "<td><a href='del_inv.php?pid=".$row['pid']."'><i class='fa fa-trash' aria-hidden='true' style='color:red;'></a></td>";
	echo "</tr>";
	$i++;
}
?>
