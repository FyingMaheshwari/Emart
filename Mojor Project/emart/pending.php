...
<html>
   ...
   <body>
      ...
      <div class="header-bar">
            ...
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
               <div class="shop_inner_inf">
                  <div class="privacy about">
                     <h3>Pending<span> Orders</span></h3>
                     <div class="checkout-right">
                        <h4>Pending Order contains <span>these Products:</span></h4>
         ...
         $sql = "select uemail,ono,product,img,qty,tprice,ostatus,oid from orders where ostatus='Pending' order by oid desc;";
         ...
         {?>
            ...
            <td class="invert"><button type="button" class="btn btn-warning"><?php echo $row['ostatus']; ?></button></td>
            <?php
            $id = $row['oid'];
            echo '<td class="invert"><a href="upd_status.php?oid='.$id.'"><button type="button" class="btn btn-outline-success">Delivered</button></a></td>';
            ?>
         </tr>
         <?php 
         $i++;
